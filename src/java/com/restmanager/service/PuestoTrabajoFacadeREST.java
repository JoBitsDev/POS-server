...
public class PuestoTrabajoFacadeREST extends AbstractFacade<PuestoTrabajo> {
    ...
    public PuestoTrabajoFacadeREST() {
    ...
    public void create(PuestoTrabajo entity) {
        super.create(entity);
    }
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") String id, PuestoTrabajo entity) {
        super.edit(entity);
    }
    ...
    public PuestoTrabajo find(@PathParam("id") String id) {
    ...
    @Path("{from}/{to}")
    @Produces({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public List<PuestoTrabajo> findRange(@PathParam("from") Integer from, @PathParam("to") Integer to) {
