...
import com.restmanager.DatosPersonales;
...
@Path("com.restmanager.datospersonales")
public class DatosPersonalesFacadeREST extends AbstractFacade<DatosPersonales> {
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") String id, DatosPersonales entity) {
        super.edit(entity);
    }
    ...
    public DatosPersonales find(@PathParam("id") String id) {
