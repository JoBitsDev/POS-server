...
import com.restmanager.ProductovOrdenPK;
...
public class ProductovOrdenFacadeREST extends AbstractFacade<ProductovOrden> {
    ...
    private ProductovOrdenPK getPrimaryKey(PathSegment pathSegment) {
         ...
         */
        com.restmanager.ProductovOrdenPK key = new com.restmanager.ProductovOrdenPK();
    ...
    public void remove(@PathParam("id") PathSegment id) {
        com.restmanager.ProductovOrdenPK key = getPrimaryKey(id);
